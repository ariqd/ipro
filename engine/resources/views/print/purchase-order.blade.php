    ...
    <div class="col-xs-12" style="margin-top: 0%">
        ...
        <div class="col-xs-5" style="font-size: 12px">
            ...
            <table width="80%" style="font-size: 11px;float: right">
                <tr>
                    <td colspan="2"><p class="text-center" style="margin:0 auto">Customer Code</p></td>
                </tr>
                <tr>
                    <td colspan="2"><p class="text-center" style="margin:0 auto; font-size: 19px">000000</p></td>
                </tr>
            </table>
        </div>
    </div>
