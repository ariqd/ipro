        ...
        <table width="80%" style="font-size: 11px;float: right">
            <tr>
                <td width="40%" colspan="2">
                    <p class="text-center" style="margin:0 auto; font-size: 18px"><b>KWITANSI<br>CASH
                            RECEIPT</b></p>
                </td>
            </tr>
            <tr>
                <td width="40%">
                    <p class="text-left" style="margin:0 auto"> &emsp;<u>No QO</u> <br>&emsp;No SO</p>
                </td>
                <td width="40%">
                    <p class="text-left" style="margin:0 auto"> &emsp;<u>{{ $QO }}</u>
                        <br>&emsp;{{ $SO }}</p>
                </td>
            </tr>
