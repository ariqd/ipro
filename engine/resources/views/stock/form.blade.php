    ...
    <div class="modal-body">
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                <input id="brand" class="form-control" name="brand" value="{{ @$isEdit ? $stock->brand : '' }}">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-lg-12">
                <label for="code" class="form-control-label">Kode Produk</label>
                <input id="code" class="form-control" name="code" value="{{ @$isEdit ? $stock->code : '' }}">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-lg-12">
        ...
        <div class="form-group row">
            <div class="col-lg-12">
                ...
                <input id="branch" class="form-control" name="branch" value="{{ @$isEdit ? $stock->branch : '' }}">
