            ...
            <div class="collapse" id="collapseExample">
                <div class="card card-body">
                    <form action="{{ url('stocks') }}" id="find-table" method="get">
                        <div class="row">
                            <label for="brands" class="col-lg-2 col-form-label text-right">
                                <h4>Brands :</h4>
                            </label>
                            <div class="col-lg-10">
                                <div class="row p-2">
                                    ...
                                    <div class="col-lg-2 mb-2">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="brands[]" class="custom-control-input check"
                                                id="{{ $brand->name }}" value="{{ $brand->id }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <div class="row p-2">
                                    ...
                                    <div class="col-lg-2 mb-2">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="branches[]" class="custom-control-input check"
                                                id="{{ $branch->name }}" value="{{ $branch->id }}">
                                            <label class="custom-control-label"
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="#modalForm" data-href="{{ url('stocks/'.$stock->id.'/restock') }}"
                                        ...
                                        <a href="#modalForm" data-toggle="modal"
                                            data-href="{{ url('stocks/'.$stock->id) }}" class="dropdown-item">
                                            <i class="fa fa-eye"></i> Detail</a>
                                        <a title="Edit" class="dropdown-item" href="#modalForm" data-toggle="modal"
