                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-4">
                        ...
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="payment_method_cbd">Cash Before Delivery (CBD)</label>
                        </div>
                        ...
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="payment_method_cod">Cash On Delivery (COD)</label>
                        </div>
                        <div class="custom-control custom-radio mt-2">
                            <input type="radio" id="payment_method_credit" name="payment_method"
                            class="custom-control-input" value="Credit">
                            <label class="custom-control-label" for="payment_method_credit">Down Payment / Credit</label>
                        </div>
                        @endif
                    </div>
                </div>
